...
class DropdownUnitButton extends StatelessWidget {
  final List<ProductUnit> listItems;
  final void Function(ProductUnit?) onChange;
  ...
  Widget build(BuildContext context) {
    return DropdownButtonFormField<ProductUnit>(
      ...
      items: (listItems).map((ProductUnit item) {
