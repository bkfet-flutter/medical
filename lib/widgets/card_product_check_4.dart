...
class CardProductCheck4 extends StatefulWidget {
  ...
  @override
  State<CardProductCheck4> createState() => _CardProductCheck4State();
}

class _CardProductCheck4State extends State<CardProductCheck4> {
  @override
                      ...
                      onChange: (value) {
                        setState(() {
                          widget.inboundModel.priceUnitController?.text =
                              (widget.inboundModel.product!.primePrice! *
                                      value!.exchangeValue!)
                                  .toString();
