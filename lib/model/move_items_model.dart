class MoveItemsModel {
  ...
  MoveItemsModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    code = json['code'];
...
class ToBatches {
  ...
  ToBatches({this.id, this.quantity, this.batch});

  ToBatches.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class Batch {
  ...
  Batch({this.id, this.name, this.quantity, this.expiryDate});
...
class FromBatches {
  ...
  FromBatches({this.id, this.quantity, this.batch});

  FromBatches.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    quantity = json['quantity'];
    batch = json['batch'] != null ? new Batch.fromJson(json['batch']) : null;
  }
