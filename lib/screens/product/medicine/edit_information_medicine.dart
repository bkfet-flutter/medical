...
class EditInformationMedicine extends StatefulWidget {
  const EditInformationMedicine({super.key});

  @override
  State<EditInformationMedicine> createState() =>
      _EditInformationMedicineState();
}

class _EditInformationMedicineState extends State<EditInformationMedicine> {
  int? groupProductId;
                ...
                onPressed: () async {
                  ...
                  dataUnits = listUnitProducts
                      .map((e) => {
                            ...
                            "exchangeValue": e.value.text.isEmpty
                                ? 0
                  ...
                  if (true == true) {
                    ...
                    ApiResponse resAdd = await ApiRequest.editMedicineProduct(
                      id: id,
                      name: name.text,
