...
class CopyProductScreen extends BaseScreen {
  const CopyProductScreen({super.key});

  @override
  CopyProductScreenState createState() => CopyProductScreenState();
}

class CopyProductScreenState extends BaseState<CopyProductScreen>
              ...
              child: MepharButton(
                ...
                onPressed: () async {
                  ...
                  if (true == true) {
                    ...
                    ApiResponse resAdd = await ApiRequest.addProduct(
