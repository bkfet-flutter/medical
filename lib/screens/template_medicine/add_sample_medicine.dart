...
class AddInformationSampleMedicine extends StatefulWidget {
  const AddInformationSampleMedicine({super.key});

  @override
  State<AddInformationSampleMedicine> createState() =>
      _AddInformationSampleMedicineState();
}

class _AddInformationSampleMedicineState
    extends State<AddInformationSampleMedicine> {
