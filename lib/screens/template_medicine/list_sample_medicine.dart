                        ...
                        itemBuilder: (context, index) {
                          return CardProductCheck(
                            ...
                            listData: [
                              {
                                ...
                                "titleRight": sample.listSample[index].code,
                              },
                              {
                                "titleLeft": "Tên đơn thuốc",
                                "titleRight": sample.listSample[index].name,
                              },
                              {
                                "titleLeft": "Tổng mua",
                                "titleRight":
                              ...
                              AppFunction.showDialogAlert(context,
                                  ...
                                  widgetDescription: Column(
                                    children: [
                                      ...
                                      Text(
                                        "Bạn có chắc chắn muốn xóa đơn thuốc mẫu ${sample.listSample[index].name}?",
                                  ...
                                  onPress2ndButton: () async {
                                    AppFunction.showLoading(context);
                                    ApiResponse res =
                                        await ApiRequest.deleteSampleMedicine(
                            ...
                            onPressed: () async {
                              ...
                              Navigator.pushNamed(
                                context,
                                AppRoutes.detailInformationSampleMedicine,
                            ...
                            onTapEdit: () {
                              Navigator.pushNamed(
                                context,
                                AppRoutes.editInformationSampleMedicine,
                              );
                            },
                          );
                        },
